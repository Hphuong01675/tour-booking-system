      ...
      <main className="flex-grow flex items-center justify-center pt-24 pb-12 px-margin-mobile">
        <div className="max-w-6xl w-full grid md:grid-cols-2 bg-surface-container-lowest rounded-xl overflow-hidden shadow-lg border border-outline-variant">
          ...
          <div className="relative hidden md:block">
            ...
            />
            <div className="relative z-20 h-full flex flex-col justify-end p-xl text-white">
              <h2 className="text-display-lg font-display-lg mb-sm">Khám phá thế giới theo cách của bạn.</h2>
          ...
          <div className="p-lg md:p-xl flex flex-col">
            <div className="mb-lg">
              <h1 className="text-headline-md font-headline-md text-on-surface mb-xs">Tạo tài khoản mới</h1>
