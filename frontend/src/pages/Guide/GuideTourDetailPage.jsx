...
const QRScanner = ({ assignmentId, onClose, onCheckinSuccess }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-on-background/40 backdrop-blur-sm">
      <div className="bg-surface-container-lowest rounded-2xl p-xl max-w-sm w-full shadow-2xl relative overflow-hidden">
  ...
  return (
    <div className="flex flex-col min-h-full bg-background">
      ...
      {showCccdModal && cccdTargetParticipant && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-on-background/40 backdrop-blur-sm">
          <div className="bg-surface-container-lowest rounded-2xl p-xl max-w-xl w-full shadow-2xl relative">
            <div className="flex justify-between items-center mb-md border-b border-outline-variant/30 pb-xs">
              <h3 className="font-headline-sm text-primary flex items-center gap-xs">
      ...
      {showViewCccdModal && viewCccdParticipant && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-on-background/60 backdrop-blur-sm">
          <div className="bg-surface-container-lowest rounded-2xl p-xl max-w-3xl w-full shadow-2xl relative max-h-[90vh] flex flex-col">
      ...
      {showPrivateEmailModal && privateEmailTarget && (
        <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/40 backdrop-blur-sm p-4">
          <div className="bg-surface-container-lowest w-full max-w-lg rounded-xl p-xl shadow-xl">
      ...
      {showNotificationModal && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-on-background/40 backdrop-blur-sm">
          <div className="bg-surface-container-lowest rounded-2xl p-xl max-w-md w-full shadow-2xl">
            <div className="flex justify-between items-center mb-md border-b border-outline-variant/30 pb-xs">
              <h3 className="font-headline-sm text-primary flex items-center gap-xs">
              ...
              <div className="space-y-md">
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => setNotificationMsg(prev => ({ ...prev, type: e.target.value }))}
                  ...
                  >
                    ...
                    onClick={async () => {
                      ...
                      try {
                        setIsSending(true);
                        const payload = {
                          type: notificationMsg.type || 'announcement',
