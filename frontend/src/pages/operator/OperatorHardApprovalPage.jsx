// Path: frontend/src/pages/operator/OperatorHardApprovalPage.jsx
                    ...
                    <div className="bg-primary rounded-xl p-s-xl text-white relative overflow-hidden animate-pulse">
                        ...
                        <div className="relative z-10">
                            ...
                            <p className="text-sm text-white/80 mb-s-lg leading-relaxed">
                                Bạn hãy kiểm tra kỹ ảnh chụp CCCD/Hộ chiếu mặt trước và mặt sau của các hành khách trong các tour Hard dưới đây trước khi duyệt.
                            </p>
                        </div>
                    </div>
