...
const LoginForm = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        if (loginUser.fulfilled.match(result)) {
            ...
            let defaultRedirect = "/";
            if (userRole === "customer") defaultRedirect = "/customer/tours";
            else if (userRole === "guide") defaultRedirect = "/guides/tours";
            else if (userRole === "operator") defaultRedirect = "/operator/dashboard";
            else if (userRole === "admin") defaultRedirect = "/admin/dashboard";

            navigate(result.payload.redirectUrl || defaultRedirect, { replace: true });
        }
    };
