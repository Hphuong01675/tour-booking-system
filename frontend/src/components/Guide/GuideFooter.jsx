...
const GuideFooter = () => {
    return (
        <footer className="bg-surface border-t border-outline-variant/20 py-lg px-margin-mobile md:px-margin-desktop text-on-surface-variant/70">
            <div className="max-w-[1440px] mx-auto flex flex-col md:flex-row items-center justify-between gap-md text-sm">
                <div>
