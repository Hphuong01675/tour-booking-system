...
const seedDatabase = async () => {
    try {
        ...
        const tour = await Tour.create({
            ...
            description:
                "Quản lý lịch trình, điều phối khách hàng và theo dõi tiến độ đoàn du lịch miền Trung.",
        ...
        await TourItineraryDay.bulkCreate([
            {
                ...
                description:
                    "Đón đoàn tại Sân bay Đà Nẵng, dùng bữa trưa đặc sản Trần. Nhận phòng resort và tự do tắm biển Mỹ Khê.",
            },
            {
                id: "itinerary-day-2",
                tourId: "tour-1",
                ...
                description:
                    "Tham quan KDL Bà Nà Hills, trải nghiệm cáp treo đạt kỷ lục và check-in Cầu Vàng trong sương sớm.",
            },
            {
                id: "itinerary-day-3",
                tourId: "tour-1",
                ...
                description:
                    "Tham quan làng gốm Thanh Hà, dạo bộ Phố Cổ và xem show diễn thực cảnh lớn nhất Việt Nam.",
            },
        ]);
        ...
        await Conversation.create({
            ...
            status: "active",
            lastMessage:
                "Dạ có ạ, gửi giúp mình nhé. Đặc biệt là các hoạt động cho trẻ em ấy ạ...",
        });
        ...
        await Message.bulkCreate([
            {
                ...
                senderId: "customer-1",
                content:
                    "Chào admin, tôi muốn hỏi về tour Hạ Long ngày 25/12 còn chỗ không ạ? Nhóm tôi có 4 người lớn và 2 trẻ em.",
            ...
            },
            {
                ...
                senderId: "guide-1",
                content:
                    "Chào chị Minh Anh! Chip3Chip rất vui được hỗ trợ chị. Ngày 25/12 bên em vẫn còn chỗ cho đoàn 6 người trên tàu Heritage Cruises chị nhé.",
            ...
            },
            {
                ...
                senderId: "guide-1",
                content:
                    "Chị có cần em gửi bảng giá chi tiết kèm ưu đãi cho trẻ em không ạ?",
            ...
            },
            {
                ...
                senderId: "customer-1",
                content:
                    "Dạ có ạ, gửi giúp mình nhé. Đặc biệt là các hoạt động cho trẻ em ấy ạ, vì các bé nhà mình khá năng động.",
        ...
        await Conversation.create({
            ...
            status: "active",
            lastMessage:
                "Cảm ơn bạn, mình cần hỏi thêm về chính sách hủy tour.",
        });
        ...
        await Message.bulkCreate([
            {
                ...
                senderId: "customer-2",
                content:
                    "Gói bảo hiểm du lịch có bao gồm cứu hộ núi không bạn?",
            ...
            },
            {
                ...
                senderId: "guide-1",
                content:
                    "Dạ chào anh Khánh, gói bảo hiểm của Chip3Chip đã bao gồm toàn bộ chi phí y tế khẩn cấp và cứu hộ tại chỗ ở Sapa ạ.",
        ...
        await Conversation.create({
            ...
            status: "waiting",
            lastMessage:
                "Tôi muốn đặt tour du lịch cho gia đình vào tuần tới tại Nha Trang.",
        });
        ...
        await Message.create({
            ...
            senderId: null,
            content:
                "Tôi muốn đặt tour du lịch cho gia đình vào tuần tới tại Nha Trang. Cho mình xin thông tin khách sạn.",
        ...
        await Conversation.create({
            ...
            status: "waiting",
            lastMessage:
                "Thanh toán bằng thẻ Visa có mất phí chuyển khoản không ạ?",
        });
        ...
        await Message.create({
            ...
            senderId: null,
            content:
                "Hello! I'm looking for a private English-speaking guide in Ho Chi Minh City for a food tour.",
